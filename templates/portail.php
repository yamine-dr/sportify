		...
		<div class="pt-lg-16 px-lg-16 col-12 col-md-9 col-lg-7 offset-xl-7 offset-lg-5 d-flex flex-column justify-content-center position-relative">
			<div class="row">
				<div class="col-lg-10 col-md-9 col-xl-8 col-xxl-7 mx-auto ms-xl-0">
					...
					<form class="mt-4 vstack gap-4" method="post" action="./verification.php">
						<div>
					...
					<!-- other connexion methods -->
					<div class="py-5 text-center">
						<span class="text-xs fw-semibold">OU</span>
					</div>
					<div class="row g-3 justify-content-center align-items-center">
						<!-- Google button -->
						<div class="col-sm-6 col-sm-6 d-flex justify-content-center align-items-center">
